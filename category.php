...
if($category_id == null || $category_id == '') {
	...
	$sql = "select Product.*, Category.name as category_name from Product left join Category on Product.category_id = Category.id where Product.deleted = 0 and Product.category_id = $category_id order by Product.updated_at desc limit 0,12";
}
